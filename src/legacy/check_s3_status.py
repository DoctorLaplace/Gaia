...
def check_s3():
    ...
    try:
        ...
        result_ls = subprocess.run(ls_cmd, stdout=subprocess.PIPE, text=True, stderr=subprocess.DEVNULL)
        ...
        result_du = subprocess.run(du_cmd, stdout=subprocess.PIPE, text=True, stderr=subprocess.DEVNULL)
